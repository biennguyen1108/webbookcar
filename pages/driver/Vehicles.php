...
<div class="wrapper">
        ...
        <div class="content-wrapper" style="margin-left:250px">
            <h2 style="margin-left: 400px; ">Danh sách phương tiện</h2>

            <button style="margin-bottom:20px;margin-left: 40px;background-color:#ff5e14;border:none"> <a href="../driver/addvehicles.php" style="text-decoration: none;color:#fff">Thêm</a></button>
