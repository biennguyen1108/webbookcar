...
<div class="wrapper">
        ...
        <div class="content-wrapper" style="margin-left:250px">
            <h2 style="margin-left: 400px; ">DANH SÁCH GỬI HÀNG </h2>
   ...
   if (!$conn) {
    ...
    $sql= "SELECT*FROM drivers, trips, items, receiver ,payment,users WHERE items.id_users= users.id_users AND items.id_trips = trips.id_trips      AND items.id_items= receiver.id_items AND items.id_items=payment.id_items AND trips.id_drivers= drivers.id_drivers ";
